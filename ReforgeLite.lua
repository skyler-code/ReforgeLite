...
function ReforgeLite:CreateOptionList ()
  ...
  self.savePresetButton:SetSize(114, 22)
  ...
  self.deletePresetButton:SetSize(114, 22)
  ...
  self.storedClear:SetSize(114, 22)
  ...
  self.storedRestore:SetSize(114, 22)
...
function ReforgeLite:FillSettings ()
  ...
  self.debugButton:SetSize(114, 22)
...
function ReforgeLite:UpdateMethodCategory ()
  if self.methodCategory == nil then
    ...
    self.methodShow:SetSize(114, 22)
