...
local function CreateErrorFrame()
  ...
  ExportFrame.ok = CreateFrame ("Button", nil, ExportFrame, "UIPanelButtonTemplate")
  ExportFrame.ok:SetSize (112, 22)
  ExportFrame.ok:SetText (ACCEPT)
  ExportFrame.ok:SetPoint ("BOTTOM", 0, 10)
  ExportFrame.ok:SetScript ("OnClick", function (frame) frame:GetParent():Hide () end)
  ...
  ExportFrame.scroll:SetPoint ("BOTTOM", ExportFrame.ok, "TOP", 0, 10)
  ExportFrame.text = CreateFrame ("EditBox", nil, ExportFrame.scroll)
  ExportFrame.scroll:SetScrollChild (ExportFrame.text)
  ExportFrame.text:SetWidth (274)
  ExportFrame.text:SetHeight (100)
